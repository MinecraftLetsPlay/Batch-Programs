...
echo.
echo.
echo  IN THIS PROGRAM, YOU CAN FIND SOME EXPLENATION ABOUT THE COMMANDS / FUNCTIONS
echo.
echo  AND HOW TO USE THEM / WHAT THEY DO OR SHOW
echo.
echo.
echo  THE EXPLENATION OF SOME COMMANDS / FUNCTIONS INCLUDE THE WINDOWS COMMAND EXPLENATIONS (MARKED WITH (+WH) BEHIND TITLE)
echo.
echo.
echo.
echo  MAIN MENU
...
echo  SYSTEMINFO
echo.
echo  SHOWS ALL SYSTEMINFORMATIONS OF THIS PC
echo.
echo.
echo  ITS A DETAILED LIST OF ALL ASPECTS OF THE PC (LIKE OS, BIOS AND MUCH MORE)
echo.
...
echo  USERINFO
echo.
echo  SHOWS ALL THE REGISTERED USER ON THIS PC
echo.
...
echo  IP CONFIG
echo.
echo  ALL INFOS ABOUT THE NETWORK CONNECTIONS OF THE PC WILL BE DISPLAYED HERE
echo.
echo.
echo  INSTALLED ETHERNET ADAPTERS AND THEIR INFORMATIONS (LIKE IPv4/IPv6 ADRESSES)
echo.
...
echo.
echo.
echo  CAN ALSO DETECT PROBLEMS AND FIXES THEM IF POSSIBLE
echo.
echo.
echo  E.G. TARGET:C:
echo.
...
echo  DIR (+WH)
echo.
echo  A LIST OF ALL FOLDERS AND FILES OF THE SPECIFIED DRIVE / FOLDER WILL BE DISPLAYED HERE
echo.
echo  E.G. TARGET (DRIVE):C:\     OR     TARGET (FOLDER):C:\USERS
echo.
...
echo  PING
echo.
echo  SENDS DATA-PACKETS OVER THE NETWORK (INTERNET) TO THE TARGET AND WAITS FOR ANSWERS, TO DETERMINE PAKET LOSS AND DELAY
echo.
...
echo.
echo  SHOWS THE SERVERS TROUGH WHICH THE DATA TRAFFIC PASSES TO THE DESTINATION 
echo.
echo.
echo  E.G. TARGET (DEVICE):Fritz.box     OR     TARGET (WEBSITE):Google.com   ALSO ACCEPTS IP ADRESSES
echo.
echo.
echo  WILL BE DISPLAYED LIKE THIS: (NUMBER OF HOPS (SERVER)   DELAY MIN.   DELAY MAX.   DELAY AVG.   NAME / IP ADRESS)
echo.
...
echo.
echo  WARNING: ALL FILES / FOLDERS THIS DISK CONTAINS WILL BE COMPLETLY ERASED! THIS DATA CAN'T BE EASILY RESTORED ANYMORE!
echo.
...
echo.
echo  E.G. MD (PATH)\(NAME): C:\Windows\HALLO  WILL CREATE A FOLDER NAMED "HALLO" AT C:\Windows
echo.
